...
const services = [
  ...
  { icon: Palette,      title: "Graphic Design",                 desc: "Logos, flyers, branding & print — from KES 500",         href: "/services#graphic",    color: "text-pink-400" },
          ...
          >
            <div className="pt-24 pb-8 px-6">
              ...
              <div>
                ...
                <AnimatePresence>
                  {mobileExpanded === "company" && (
                    <motion.div initial={{ height: 0 }} animate={{ height: "auto" }} exit={{ height: 0 }} className="overflow-hidden">
                      {company.map((c) => (
                        <Link key={c.title} href={c.href} onClick={() => setMobileOpen(false)}
                          className="flex items-center gap-3 py-3 pl-4 text-gray-300 hover:text-white border-b border-white/5">
              ...
              <div className="mt-8 space-y-4">
                <a href="tel:+254707528980" className="flex items-center gap-3 text-gray-300">
                  <Phone size={16} className="text-accent" /><span>+254 707 528 980</span>
                </a>
                <a href="tel:+254792837632" className="flex items-center gap-3 text-gray-300">
                  <Phone size={16} className="text-accent" /><span>+254 792 837 632</span>
                </a>

                <Link href="/book" onClick={() => setMobileOpen(false)}
                  className="flex items-center justify-center gap-2 w-full bg-accent text-dark font-bold py-4 rounded-xl mt-4 text-lg">
                  <Calendar size={18} /> Book Free Consultation
                </Link>
                <Link href="/contact" onClick={() => setMobileOpen(false)}
                  className="flex items-center justify-center w-full border border-white/20 text-white font-semibold py-3 rounded-xl text-base">
                  Send a Message
                </Link>
              </div>
            </div>
